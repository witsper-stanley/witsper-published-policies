...
├── README.md                              ← 本檔(總索引)
├── <文件名>_v<N>_<YYYY-MM-DD>.pdf         ← 公佈版 PDF
├── <文件名>_v<N>_<YYYY-MM-DD>.md          ← 當時 source markdown snapshot (audit 用)
└── ...
```
...
範例:
- `電腦設備管理原則_v1_2026-06-02.pdf`
- `電腦設備管理原則_v1_2026-06-02.md`(對應 source markdown snapshot)
- `天然災害停班出勤機制_v1_2026-06-02.pdf`
...
2. 走《核決權限表》核准重新公佈
3. Render 新公佈版 PDF
4. 在**本 repo** commit 新 PDF + source snapshot(檔名用新 Version N+1)
